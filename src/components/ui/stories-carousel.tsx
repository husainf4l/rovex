...
export const Story = ({ className, ...props }: StoryProps) => (
  <CarouselItem className={cn('basis-auto !w-[220px] pl-2 md:pl-4', className)}>
    <div
      className={cn(
        'group relative overflow-hidden rounded-2xl bg-muted/40',
...
export const StoryAuthor = ({ className, children, ...props }: StoryAuthorProps) => (
  <div
    className={cn('absolute right-0 bottom-0 left-0 z-10 p-4 text-white', className)}
    {...props}
  >
...
export const StoryTitle = ({ className, ...props }: StoryTitleProps) => (
  <div
    className={cn('absolute top-0 right-0 left-0 z-10 p-4 text-white', className)}
    {...props}
  />
);
...
export const StoryOverlay = ({
  ...
  return (
    <div
      className={cn(
        'absolute right-0 left-0 h-40 from-black/60 to-transparent',
        positionClasses,
        className
      )}
      {...props}
